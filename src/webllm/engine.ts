    ...
    messages: [
      {
        role: "system",
        content: [
          "You are a local browser-only banking dispute form drafting assistant POC.",
          "Use only the mock transaction and form details provided by the user.",
          ...
          "Do not request real account, card, credential, authentication, or personally sensitive data.",
        ].join(" "),
      },
    ...
    messages: [
      {
        role: "system",
        content: [
          "You are a local browser-only banking transaction search assistant POC.",
          "Use only the mock transaction search query and mock search results provided by the user.",
          "Do not claim to access real accounts, balances, card systems, or bank records.",
    ...
    messages: [
      {
        role: "system",
        content: [
          "You are a local browser-only banking transaction visualization assistant POC.",
          "Use only the mock chart request and mock aggregated chart data provided by the user.",
          "Do not claim to access real accounts, balances, card systems, or bank records.",
          "Explain the chart in customer-friendly language and call out simple spending patterns.",
          "Generate concise output with these headings: Chart interpretation, Key takeaways, Suggested next actions, Demo note.",
          "Do not provide regulated financial advice and do not ask for real account numbers, card numbers, credentials, or sensitive personal data.",
        ].join(" "),
      },
      { role: "user", content: userPrompt },
    ],
