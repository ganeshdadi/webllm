      ...
      messages: [
        {
          ...
          content: [
            ...
            "The customer's query is authoritative. Field descriptions are not example answers.",
            "Return exactly one fenced JSON block with matchedTransactionIds, searchInterpretation, matchingRationale, and helpfulNextActions.",
            "Keep JSON string values plain text without markdown syntax or backslashes.",
            "Do not request account identifiers, payment card details, credentials, authentication codes, or other sensitive personal or financial information.",
          ].join(" "),
        },
        { role: "user", content: userPrompt },
      ...
      messages: [
        {
          ...
          content: [
            ...
            "The customer's chart request is authoritative. Field descriptions are not example answers.",
            "Return exactly one fenced JSON block with chartTitle, chartData, chartInterpretation, keyTakeaways, and suggestedNextActions.",
            "Keep JSON string values plain text without markdown syntax or backslashes.",
            "Do not request account identifiers, payment card details, credentials, authentication codes, or other sensitive personal or financial information.",
          ].join(" "),
        },
