      ...
      messages: [
        {
          ...
          content: [
            ...
            "Return one small JSON object with matchedTransactionIds only.",
            "Do not include markdown, explanations, calculations, JavaScript expressions, or dataset repeats.",
            "Do not request account identifiers, payment card details, credentials, authentication codes, or other sensitive personal or financial information.",
          ].join(" "),
        },
        { role: "user", content: userPrompt },
      ...
      messages: [
        {
          ...
          content: [
            ...
            "Return one small JSON object with chartTitle and chartData only.",
            "Do not include markdown, explanations, calculations, JavaScript expressions, or dataset repeats.",
            "Do not request account identifiers, payment card details, credentials, authentication codes, or other sensitive personal or financial information.",
          ].join(" "),
        },
